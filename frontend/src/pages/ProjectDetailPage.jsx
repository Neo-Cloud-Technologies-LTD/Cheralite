  ...
  if (!project) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center px-6 py-20 text-center bg-[#FAF9F8]">
        <div className="bg-white p-10 rounded-xl shadow-lg max-w-lg border border-gray-100">
    ...
    <div className="bg-[#FAF9F8] min-h-screen">
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <nav className="flex items-center text-sm font-body text-gray-500 mb-6 space-x-2 flex-wrap">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider font-body">Client</p>
            <p className="text-sm font-bold text-primary font-heading mt-1 truncate" title={project.client}>
              {project.client}
            </p>
          </div>

          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider font-body">Location</p>
            <p className="text-sm font-bold text-primary font-heading mt-1 truncate" title={project.location}>
              {project.location}
            </p>
          </div>

          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider font-body">Year</p>
            <p className="text-sm font-bold text-primary font-heading mt-1">{project.year}</p>
          </div>

          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider font-body">Duration</p>
            <p className="text-sm font-bold text-primary font-heading mt-1">{project.duration}</p>
          </div>

          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider font-body">Project Value</p>
            <p className="text-sm font-bold text-secondary font-heading mt-1">{project.value}</p>
          </div>

          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider font-body">Total Area</p>
            <p className="text-sm font-bold text-primary font-heading mt-1">{project.area}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            {(project.challenges || project.solutions) && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {project.challenges && (
                  <div className="bg-white p-6 rounded-2xl border border-red-50 shadow-sm border-l-4 border-l-amber-500">
                ...
                {project.solutions && (
                  <div className="bg-white p-6 rounded-2xl border border-blue-50 shadow-sm border-l-4 border-l-secondary">
                    <div className="flex items-center gap-2 mb-3">
            ...
            {/* Results / Impact */}
            {project.results && (
              <div className="bg-gradient-to-r from-blue-900 to-[#002068] text-white p-8 rounded-2xl shadow-lg">
          ...
          <div className="space-y-6 lg:sticky lg:top-8">
            ...
            <div className="bg-white p-6 rounded-2xl border border-blue-100 shadow-md">
              ...
              <Link
                to="/contact"
                className="w-full block text-center bg-[#002068] text-white font-medium py-3 rounded-lg hover:bg-secondary transition-all shadow-md active:scale-95 font-body"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {relatedProjects.map((rel) => (
                <Link
                  ...
                  className="bg-white rounded-xl shadow-md overflow-hidden hover:-translate-y-1.5 transition-all duration-300 border border-gray-100 group flex flex-col"
                >
